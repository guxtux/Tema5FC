...
% Para diferentes valores de $N$ número de pasos, gráfica $\sqrt{N}$ vs $R$ la longitud total de la caminata.
% \\
% \bigskip
% Discute tus resultados, es decir, ¿hay diferencia entre lo esperado con lo obtenido? Explica la respuesta que proporciones.
% \end{frame}
\end{document}